import { useState, useRef } from "react"; // Uncommented
import audio1 from '../../assets/testtest.mp3' // Assuming assets path
import audio2 from '../../assets/chatgptlofi.mp3'
import MusicPlayer from "./MusicPlayer"; // Uncommented
                ...
                {selectedAudio && selectedAudio !== "default" ?
                    <>
                        ...
                        <div className="cutButtons">
                            <button onClick={() => setCutStart(audioRef.current.currentTime || 0)}>Start Cut</button>
                            <button onClick={() => setCutEnd(audioRef.current.currentTime || 0)}>End Cut</button>
                        </div>
                    </>
                    :
                    <p>None selected</p>
